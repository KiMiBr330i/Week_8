...
public class Lab8_Ex3 {
	...
	a) What is the root node of the tree? - Node 50
	b) What are the leaf nodes of the tree? - Nodes 9, 14, 19, 67, and 76
	c) What are the ancestor nodes of the node containing node 19? - 23, 17, 50
